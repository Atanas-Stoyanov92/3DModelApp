...
ALLOWED_HOSTS = ['threedmodelapp.onrender.com']
...
INSTALLED_APPS = [
    ...
    'Djangoadvanceproject.accounts',
    'Djangoadvanceproject.common',
...
ROOT_URLCONF = 'Djangoadvanceproject.urls'
...
WSGI_APPLICATION = 'Djangoadvanceproject.wsgi.application'
...
AUTH_USER_MODEL = 'accounts.ThreeDUser'
